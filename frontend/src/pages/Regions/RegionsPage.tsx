          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
              selectedReg?.region_id === reg.region_id
                ...
                : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:bg-slate-800'
            }`}
          >
      ...
      {selectedReg && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-xs space-y-6">
            ...
            <div className="p-4 rounded-xl bg-ocean-50 border border-ocean-200 text-slate-700 dark:text-slate-300 text-xs leading-relaxed space-y-2">
