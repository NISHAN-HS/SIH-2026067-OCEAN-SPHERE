...
import { Waves, Shield, Database, Cpu, Award } from 'lucide-react';

export const AboutPage: React.FC = () => {
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <div className="text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ocean-50 text-ocean-600 border border-ocean-200 text-xs font-bold uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
        <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-xs space-y-3">
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-xs space-y-3">
          ...
          <ul className="space-y-2 text-slate-700 dark:text-slate-300">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Backend</strong>: FastAPI REST service connecting directly to native PostgreSQL (<code className="bg-slate-100 px-1 py-0.5 rounded">ocean_reliability_db</code>).</span>
            </li>
            <li className="flex items-start gap-2">
