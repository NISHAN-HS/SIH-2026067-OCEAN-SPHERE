      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              <span className="text-xl font-bold tracking-tight text-slate-900 group-hover:text-ocean-600 transition-colors">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold transition-all ${
                    isActive
                      ? 'bg-ocean-50 text-ocean-600 border border-ocean-200/80 shadow-xs'
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              title="Manual Sync"
            >
              <RefreshCw className={`w-3.5 h-3.5 text-ocean-600 ${isRefreshing ? 'animate-spin' : ''}`} />
              <span>{seconds}s</span>
            </button>
          </div>
        </div>
