...
export const TopNavbar: React.FC<TopNavbarProps> = ({
  ...
  return (
    <header className="h-[70px] bg-white dark:bg-slate-900/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-slate-200 dark:border-slate-700/90 dark:border-slate-800 shadow-xs sticky top-0 z-50 flex items-center px-4 sm:px-6">
